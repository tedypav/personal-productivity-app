...
class EditorController(QObject):
    ...
    def __init__(self, page_repo=None, page_object_repo=None):
        super().__init__()
    ...
    def get_objects(self, page_id: int) -> list:
    ...
    def get_table_meta(self, page_id: int, table_id: int):
    ...
    def create_object(
        self, page_id: int, object_type: str, content: str, sort_order: int = 0
    ) -> int:
        obj = PageObject(
            page_id=page_id,
    ...
    def get_object_meta(self, page_id: int, checklist_id: int):
