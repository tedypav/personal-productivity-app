...
class PageController(QObject):
    ...
    def __init__(self, page_repo=None, undo_manager=None):
        super().__init__()
    ...
    def delete_page(self, page_id: int) -> None:
        from src.ui.sidebar import capture_page_tree
    ...
    def get_children(self, page_id: int) -> list:
        return self._repo.get_children(page_id)

    def get_all_pages(self) -> list:
        return self._repo.get_all()

    def bulk_create_days(self, start_date, end_date) -> int:
    ...
    def bulk_create_weeks(
        self, start_date, end_date, week_start_day: str = "Monday"
    ) -> int:
        from datetime import timedelta
    ...
    def bulk_create_years(self, start_date, end_date) -> int:
        count = 0
